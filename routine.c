...
)
{
	...
	result = PathCompactPathEx (string->buffer, path->buffer, length, 0);
...
)
{
	...
	{
		result = _SystemParametersInfoForDpi (action, param1, param2, 0, dpi_value);

		return !!result;
	}

	result = SystemParametersInfo (action, param1, param2, 0);

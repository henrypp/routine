...
typedef PMOUNTMGR_MOUNT_POINTS *PMOUNTMGR_MOUNT_POINTS_PTR;
...
typedef BOOL (WINAPI *VQV) (
	...
	_Outptr_result_buffer_ (_Inexpressible_ ("buffer can be PWSTR or LPDWORD")) PVOID_PTR lplpBuffer,
	_Out_ PUINT puLen
	);
...
typedef BOOL (WINAPI *CCAAC2) (
	_Out_ HCATADMIN_PTR phCatAdmin,
...
typedef BOOL (WINAPI *CCAHFFH2)(
	...
	_In_ HANDLE hFile,
	_Inout_ LPDWORD pcbHash,
	_Out_writes_bytes_to_opt_ (*pcbHash, *pcbHash) LPBYTE pbHash,
	_Reserved_ ULONG dwFlags
	);
...
#define PR_SIZE_BUFFER_OVERFLOW 0x10000000 // 256 MB
...
C_ASSERT ((FIELD_OFFSET (R_FREE_LIST_ENTRY, body) % MEMORY_ALLOCATION_ALIGNMENT) == 0);
...
typedef struct DECLSPEC_ALIGN (16) _R_QUEUED_WAIT_BLOCK
{
	...
	volatile LONG shared_owners;
	volatile LONG flags;
} R_QUEUED_WAIT_BLOCK, *PR_QUEUED_WAIT_BLOCK;

static_assert ((sizeof (R_QUEUED_WAIT_BLOCK) % MEMORY_ALLOCATION_ALIGNMENT) == 0, "WTF!");

#define PR_QUEUED_LOCK_INIT {0}

#define PR_QUEUED_WAITER_EXCLUSIVE 0x1
#define PR_QUEUED_WAITER_SPINNING 0x2
#define PR_QUEUED_WAITER_SPINNING_SHIFT 0x1

#define PR_QUEUED_LOCK_OWNED ((LONG_PTR)0x1)
#define PR_QUEUED_LOCK_OWNED_SHIFT 0x0
#define PR_QUEUED_LOCK_WAITERS ((LONG_PTR)0x2)

// Valid only if Waiters = 0
#define PR_QUEUED_LOCK_SHARED_INC ((LONG_PTR)0x4)
#define PR_QUEUED_LOCK_SHARED_SHIFT 0x2

// Valid only if Waiters = 1
#define PR_QUEUED_LOCK_TRAVERSING ((LONG_PTR)0x4)
#define PR_QUEUED_LOCK_MULTIPLE_SHARED ((LONG_PTR)0x8)

#define PR_QUEUED_LOCK_FLAGS ((LONG_PTR)0xF)

#define _r_queuedlock_getsharedowners(value) \
	((LONG_PTR)(value) >> PR_QUEUED_LOCK_SHARED_SHIFT)

#define _r_queuedlock_getwaitblock(value) \
	((PR_QUEUED_WAIT_BLOCK)((LONG_PTR)(value) & ~PR_QUEUED_LOCK_FLAGS))
...
#define PR_RUNDOWN_REF_SHIFT 0x1
...
typedef VOID (NTAPI *PR_THREAD_FUNCTION) (
...
typedef struct _R_WORKQUEUE_ITEM
{
	...
	PR_THREAD_FUNCTION base_address;
	PVOID context;
...
typedef struct _R_WORKQUEUE
{
	...
	volatile LONG minimum_threads;
	volatile LONG maximum_threads;

	volatile LONG current_threads;
...
C_ASSERT ((FIELD_OFFSET (R_OBJECT_HEADER, body) % MEMORY_ALLOCATION_ALIGNMENT) == 0);

#if defined( _WIN64)
C_ASSERT (FIELD_OFFSET (R_OBJECT_HEADER, body) == 0x10);
#else
C_ASSERT (FIELD_OFFSET (R_OBJECT_HEADER, body) == 0x08);
#endif // _WIN64
...
#define WINDOWS_7 0x0601 // July, 2009
#define WINDOWS_8 0x0602 // August, 2012
#define WINDOWS_8_1 0x0603 // August, 2013
#define WINDOWS_10_TH1 0x0A00 // July, 2015 (version 1507, build 10240)
#define WINDOWS_10_TH2 0x0A01 // November, 2015 (version 1511, build 10586)
#define WINDOWS_10_RS1 0x0A02 // August, 2016 (version 1607, build 14393)
#define WINDOWS_10_RS2 0x0A03 // April, 2017 (version 1703, build 15063)
#define WINDOWS_10_RS3 0x0A04 // October, 2017 (version 1709, build 16299)
#define WINDOWS_10_RS4 0x0A05 // April, 2018 (version 1803, build 17134)
#define WINDOWS_10_RS5 0x0A06 // November, 2018 (version 1809, build 17763)
#define WINDOWS_10_19H1 0x0A07 // May, 2019 (version 1903, build 18362)
#define WINDOWS_10_19H2 0x0A08 // November, 2019 (version 1909, build 18363)
#define WINDOWS_10_20H1 0x0A09 // May, 2020 (version 2004, build 19041)
#define WINDOWS_10_20H2 0x0A0A // October, 2020 (build 19042)
#define WINDOWS_10_21H1 0x0A0B // May, 2021 (build 19043)
#define WINDOWS_10_21H2 0x0A0C // November, 2021 (build 19044)
#define WINDOWS_10_22H2 0x0A0D // October, 2022 (build 19045)
#define WINDOWS_11_21H2 0x0B00 // October, 2021 (build 22000)
#define WINDOWS_11_22H2 0x0B01 // September, 2022 (build 22621)
#define WINDOWS_11_23H2 0x0B02 // October, 2023 (build 22631)
#define WINDOWS_11_24H2 0x0B03 // October, 2024 (build 26100)
#define WINDOWS_11_25H2 0x0B04 // October, 2025 (build 26200)
...
#define PR_URLPARTS_SCHEME 0x0001
#define PR_URLPARTS_HOST 0x0002
#define PR_URLPARTS_PORT 0x0004
#define PR_URLPARTS_PATH 0x0008
#define PR_URLPARTS_USER 0x0010
#define PR_URLPARTS_PASS 0x0020
...
#define PR_UPDATE_FLAG_AVAILABLE 0x0001
#define PR_UPDATE_FLAG_INSTALLER 0x0002
#define PR_UPDATE_FLAG_FILE 0x0004
